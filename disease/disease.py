# -*- coding: utf-8 -*-
"""
Created on Sun Apr  7 12:30:12 2024
...
#loading the models
diabetes = pickle.load(open(r'C:\Users\tamal\Downloads\MedDetectives\notebook_files\diabetes_model.sav', "rb"))

heart_disease = pickle.load(open(r'C:\Users\tamal\Downloads\MedDetectives\notebook_files\heart_disease_model.sav', "rb"))

parkinsons_disease = pickle.load(open(r'C:\Users\tamal\Downloads\MedDetectives\notebook_files\parkinsons_model.sav', "rb"))

breast_cancer = pickle.load(open(r'C:\Users\tamal\Downloads\MedDetectives\notebook_files\breast_cancer_model.sav', "rb"))

lung_cancer = pickle.load(open(r'C:\Users\tamal\Downloads\MedDetectives\notebook_files\lung_cancer_model.sav', "rb"))
...
if (selected == "Parkinsons Disease Prediction"):
    ...
    if st.button("Parkinson's Test Result"):
        parkinsons_prediction = parkinsons_disease.predict([[fo, fhi, flo, Jitter_percent, Jitter_Abs, RAP, PPQ, DDP,
...
if (selected == "Breast Cancer Prediction"):
    ...
    if st.button("Breast Cancer Test Result"):
        breast_cancer_prediction = breast_cancer.predict([[id, radius_mean, texture_mean, perimeter_mean, area_mean,
...
if selected == "Lung Cancer Prediction":
    ...
    if st.button("Lung Cancer Test Result"):
        # Assuming lung_cancer is your trained model
        lung_cancer_report = lung_cancer.predict([[AGE, SMOKING, YELLOW_FINGERS, ANXIETY, PEER_PRESSURE,
...
def set_bg_from_url(url, opacity):
    footer = """
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-gH2yIJqKdNHPEq0n4Mqa/HGKIhSkIHeL5AyhkYV8i59U5AR6csBvApHHNl/vI1Bx" crossorigin="anonymous">
        <footer>
            <div style='visibility: visible;margin-top:7rem;justify-content:center;display:flex;'>
                <p style="font-size:1.1rem;">
                    Owned by Med Detectives
                    &nbsp;
                    <a href="https://github.com/tamalbarman/MedDitechtives.git">
...
set_bg_from_url("https://th.bing.com/th/id/OIG4.pNK2EN.KAuhH_hAiuvkt?w=1024&h=1024&rs=1&pid=ImgDetMain", opacity=0.875)
